...
!function(e, n, t) {
        ...
        for (var a in C) {
            if (C.hasOwnProperty(a)) {
                ...
                for (s = r(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) {
                    i = e[o], l = i.split("."), 1 === l.length ? Modernizr[l[0]] = s : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = s), S.push((s ? "" : "no-") + l.join("-"));
                }
            }
        }
    }
    ...
    function y(e, n, t, s, o) {
        ...
        return r(n, "string") || r(n, "undefined") ? g(l, n, s, o) : (l = (e + " " + T.join(i + " ") + i).split(" "), a(l, n, t));
    }
